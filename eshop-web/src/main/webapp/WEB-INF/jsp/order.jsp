...
<c:choose>
	...
	<c:otherwise>
		...
		<form:form commandName="userOrder" cssClass="form-horizontal">
			...
			<myTags:textfield path="city" label="city:" required="true" />
			<myTags:textfield path="street" label="street:" required="true" />
			<myTags:textfield path="zip" label="zip:" required="true" />
